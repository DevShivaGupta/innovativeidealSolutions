...
import { PaidCampaigns } from "../../helper/Data";
    ...
    <div>
        ...
        <Container className={classes.chooseContainer}>
          <div className={classes.chooseWrapper}>
            <Text component="span" className={classes.choosehead}>
              {PaidCampaigns.reasonToChoose.head}
            </Text>
            <Text component="div" className={classes.serviceDetails}>
              {PaidCampaigns.reasonToChoose.list.map((item, i) => {
      ...
      <Fade bottom>
        <Container className={classes.allSubServices}>
          Our PPC Services customized for you
        </Container>
      </Fade>
      <Fade bottom cascade>
        <Container className={classes.allServiceCard} size={"74%"} mt={60}>
          <Grid>
            {PaidCampaigns.services.map((item) => (
      ...
      <Fade bottom>
        <Container className={classes.chooseContainer}>
          <Text component="span" className={classes.choosehead}>
            {PaidCampaigns.benefits.head}
          </Text>
          <Text component="div" className={classes.serviceDetails}>
            <Text mb={20} className={classes.serviceDetails}>
              {PaidCampaigns.benefits.details}
            </Text>
            {PaidCampaigns.benefits.list.map((item, i) => {
              return <li key={i}>{item}</li>;
            })}
          </Text>
        </Container>
...
export default PaidCampaignsPage;
